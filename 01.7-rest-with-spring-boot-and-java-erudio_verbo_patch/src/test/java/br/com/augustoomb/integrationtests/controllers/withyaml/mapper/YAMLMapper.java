package br.com.augustoomb.integrationtests.controllers.withyaml.mapper;
...
public class YAMLMapper implements ObjectMapper {
    ...
    // USADO DESSA FORMA POIS JÁ FIZEMOS REFERÊNCIA A UM OUTRO PACOTE COM O MESMO NOME ACIMA (TBM CHAMADO ObjectMapper)
    ...
    public Object deserialize(ObjectMapperDeserializationContext context) {
        ...
        Class type = (Class) context.getType();  // FAZENDO UM CAST PARA O TIPO DA CLASSE
